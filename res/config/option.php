...
class ThanhDieuHeader implements ThanhDieuConfigInterface {
    ...
    public $description = "Hi my name is Le The Anh / A freelance / web developer / vexer";
    public $keywords = "Le The Anh, web Le The Anh ,nho mua thu, The Anh home,profile nho mua thu";
    public $favicon = "./res/v5/img/logo.jpg";
    public $namesite = "Le The Anh | HOME";
